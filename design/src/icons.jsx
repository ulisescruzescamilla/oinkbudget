/* icons.jsx — line icon set (stroke = currentColor) + OinkBudget mark */
...
function Icon({ name, size = 22, sw = 1.9, fill = "none", style, className }) {
  const d = ICONS[name];
  if (!d) return null;
  const paths = d.split("|").map((p, i) =>
    h("path", { key: i, d: p, fill: "none", stroke: "currentColor",
      strokeWidth: sw, strokeLinecap: "round", strokeLinejoin: "round" })
  );
  return h("svg", {
    width: size, height: size, viewBox: "0 0 24 24",
    fill: "none", style, className, "aria-hidden": true
  }, paths);
}

/* OinkBudget pig-snout mark — built from simple ellipses only */
function OinkMark({ size = 24, color = "#fff" }) {
  return h("svg", { width: size, height: size, viewBox: "0 0 32 32", "aria-hidden": true },
    h("ellipse", { cx: 16, cy: 17, rx: 11, ry: 9, fill: color }),
    h("ellipse", { cx: 9.5, cy: 8.5, rx: 3.2, ry: 4, fill: color, transform: "rotate(-18 9.5 8.5)" }),
    h("ellipse", { cx: 22.5, cy: 8.5, rx: 3.2, ry: 4, fill: color, transform: "rotate(18 22.5 8.5)" }),
    h("ellipse", { cx: 16, cy: 18, rx: 6.3, ry: 5, fill: "rgba(0,0,0,.16)" }),
    h("ellipse", { cx: 13, cy: 18, rx: 1.5, ry: 2.1, fill: "rgba(0,0,0,.32)" }),
    h("ellipse", { cx: 19, cy: 18, rx: 1.5, ry: 2.1, fill: "rgba(0,0,0,.32)" })
  );
}

Object.assign(window, { Icon, OinkMark, ICONS });
